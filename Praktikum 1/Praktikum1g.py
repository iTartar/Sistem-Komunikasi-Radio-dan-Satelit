...
from AddingBlock import AddingBlock  # grc-generated hier_block
...
class Praktikum1g(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "Praktikum1g")
        ...
        self.blocks_throttle2_1_0_0 = blocks.throttle( gr.sizeof_gr_complex*1, samp_rate, True, 0 if "auto" == "auto" else max( int(float(0.1) * samp_rate) if "auto" == "time" else int(0.1), 1) )
        ...
        self.analog_sig_source_x_2_0_0 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, 1000, 1, 0, 0)
        self.analog_sig_source_x_2_0 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, 1000, 2, 0, 0)
        self.analog_sig_source_x_2 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, 1000, 1, 0, 0)
        self.AddingBlock_0 = AddingBlock(
            samp_rate=32000,
        )
        ...
        # Connections
        ##################################################
        self.connect((self.AddingBlock_0, 0), (self.qtgui_time_sink_x_1_0, 0))
        self.connect((self.analog_sig_source_x_2, 0), (self.blocks_throttle2_1, 0))
        self.connect((self.analog_sig_source_x_2_0, 0), (self.blocks_throttle2_1_0, 0))
        self.connect((self.analog_sig_source_x_2_0_0, 0), (self.blocks_throttle2_1_0_0, 0))
        ...
        self.connect((self.blocks_throttle2_1_0_0, 0), (self.AddingBlock_0, 0))
...
def main(top_block_cls=Praktikum1g, options=None):
