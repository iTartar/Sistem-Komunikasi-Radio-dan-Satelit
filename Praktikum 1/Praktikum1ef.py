...
class Praktikum1fg(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "Praktikum1fg")
        ...
        self.blocks_throttle2_0_1_0 = blocks.throttle( gr.sizeof_char*1, samp_rate, True, 0 if "auto" == "auto" else max( int(float(0.1) * samp_rate) if "auto" == "time" else int(0.1), 1) )
        ...
        # Connections
        ##################################################
        self.connect((self.analog_random_source_x_0, 0), (self.blocks_throttle2_0_1_0, 0))
        self.connect((self.blocks_char_to_float_0_0, 0), (self.qtgui_histogram_sink_x_0, 0))
        self.connect((self.blocks_char_to_float_0_1, 0), (self.qtgui_histogram_sink_x_0_0, 0))
        self.connect((self.blocks_pack_k_bits_bb_0, 0), (self.blocks_char_to_float_0_0, 0))
        self.connect((self.blocks_throttle2_0_1_0, 0), (self.blocks_char_to_float_0_1, 0))
        self.connect((self.blocks_throttle2_0_1_0, 0), (self.blocks_pack_k_bits_bb_0, 0))
...
def main(top_block_cls=Praktikum1fg, options=None):
