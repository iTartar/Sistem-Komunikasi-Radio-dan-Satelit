...
class Nyquist(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Praktikum 2", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Praktikum 2")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "Nyquist")
        ...
        self._samp_rate_options = [0, 24000, 32000, 48000, 64000]
        # Create the labels list
        self._samp_rate_labels = ['0', '24000', '32000', '48000', '64000']
        ...
        self._freq_range = qtgui.Range(100, 32000, 1, 1000, 200)
