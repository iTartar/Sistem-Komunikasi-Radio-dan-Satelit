...
class modulasi_fm(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "modulasi fm", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("modulasi fm")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "modulasi_fm")
        ...
        self._fm_range = qtgui.Range(0, 100000, 10, 5000, 200)
        ...
        self.analog_phase_modulator_fc_0 = analog.phase_modulator_fc(beta)
    ...
    def set_beta(self, beta):
        self.beta = beta
        self.analog_phase_modulator_fc_0.set_sensitivity(self.beta)




def main(top_block_cls=modulasi_fm, options=None):
