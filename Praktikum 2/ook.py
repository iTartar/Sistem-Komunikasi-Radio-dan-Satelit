...
class ook(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._freq_range = qtgui.Range(-10000, 10000, 1, 1000, 200)
        ...
        self.blocks_repeat_0 = blocks.repeat(gr.sizeof_float*1, sas)
    ...
    def set_sas(self, sas):
        self.sas = sas
        self.blocks_repeat_0.set_interpolation(self.sas)
