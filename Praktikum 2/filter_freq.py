...
class Praktikum2t3FilterFrekuensi(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Filter Frekuensi", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Filter Frekuensi")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "Praktikum2t3FilterFrekuensi")
        ...
        self._noise_range = qtgui.Range(0, 1, 0.005, 0.01, 200)
        ...
        self._freq_range = qtgui.Range(-100000, 100000, 100, 10000, 200)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.band_reject_filter_0.set_taps(firdes.band_reject(1, self.samp_rate, 30000, 60000, 1000, window.WIN_HAMMING, 6.76))
...
def main(top_block_cls=Praktikum2t3FilterFrekuensi, options=None):
