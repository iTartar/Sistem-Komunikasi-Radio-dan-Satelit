...
class modulasi_am(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "modulasi_am")
        ...
        self.index_modul = index_modul = 0.5
        self.fm = fm = 1000
        self.fc = fc = 10000
        ...
        self._index_modul_range = qtgui.Range(0, 1, 0.1, 0.5, 200)
        self._index_modul_win = qtgui.RangeWidget(self._index_modul_range, self.set_index_modul, "'index_modul'", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._index_modul_win)
        self._fm_range = qtgui.Range(1000, 10000, 10, 1000, 200)
        ...
        self.analog_sig_source_x_0_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, fc, amplitude, 0, 0)
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, fm, amplitude, 0, 0)
        self.analog_const_source_x_0_0 = analog.sig_source_f(0, analog.GR_CONST_WAVE, 0, 0, 1)
        self.analog_const_source_x_0 = analog.sig_source_f(0, analog.GR_CONST_WAVE, 0, 0, index_modul)
    ...
    def get_index_modul(self):
        return self.index_modul

    def set_index_modul(self, index_modul):
        self.index_modul = index_modul
        self.analog_const_source_x_0.set_offset(self.index_modul)
...
def main(top_block_cls=modulasi_am, options=None):
