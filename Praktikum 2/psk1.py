...
class psk1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "psk1")
        ...
        self.interp_fir_filter_xxx_0 = filter.interp_fir_filter_ccf((samp_rate // 1000), numpy.ones(samp_rate // 1000))
...
def main(top_block_cls=psk1, options=None):
