...
class fsk(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.interp_fir_filter_xxx_0 = filter.interp_fir_filter_fff(64, numpy.ones(64))
        self.interp_fir_filter_xxx_0.declare_sample_delay(0)
        self.digital_chunks_to_symbols_xx_0 = digital.chunks_to_symbols_if([2, 4], 1)
        self.blocks_vco_f_0 = blocks.vco_f(samp_rate, ((2 * numpy.pi * dev)), 1)
